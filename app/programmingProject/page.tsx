  ...
  return (
    <div className="custom-scrollbar w-full h-full p-8 rounded-xl bg-white/10 overflow-y-auto overflow-x-hidden flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-6 text-gray-600 w-full">
        {/* Programming Project */}
        <div className="font-bold text-2xl">Programming Project</div>
        ...
        <div className="grid grid-cols-1 gap-6 w-full">
          ...
          <div className="flex flex-col gap-8 border border-gray-500/10 rounded-md p-4 w-full shadow-lg hover:scale-101 transition-all duration-500">
            <div className="group relative aspect-3/1 w-full overflow-hidden bg-gray-900 rounded-sm border border-white/70">
              <Image
                src="/bg.png"
                alt="bg"
                fill
        ...
        <div className="group relative aspect-3/1 w-full overflow-hidden bg-gray-900 rounded-sm border border-white/70">
          ...
          <div className="">
            ...
            <div className="text-gray-500 mt-2 text-sm">
              <p className="mb-4">我在這個小組專題中，負責技術（javascript、p5.js）的部分</p>
            </div>
            <div className="flex justify-around gap-6">
              <Link href="https://fengyenchia.github.io/my-page/arts/character/character.html" target="/blank" className="block w-full">
                <div className="w-full font-medium text-center mt-3 py-2 px-auto bg-gray-100 hover:bg-gray-200 text-gray-500 rounded-md transition-colors duration-200">
                  查看網站
                </div>
              </Link>
              <Link href="https://github.com/fengyenchia/js_final_projecthttps://fengyenchia.github.io/js_final_project/public/00/" target="/blank" className="block w-full">
                <div className="w-full font-medium text-center mt-3 py-2 px-auto bg-red-100 hover:bg-red-200 text-gray-500 rounded-md transition-colors duration-200">
                  Github
                </div>
              </Link>
